...
#end
`;
class AlgoliaTransformer extends graphql_transformer_core_1.TransformerPluginBase {
    constructor() {
        super('graphql-algolia-transformer', 
        /* GraphQL */ `
      ...
      `);
        this.generateResolvers = (context) => {
            ...
            const parameterMap = (0, create_cfnParameters_1.createParametersStack)(context.stackManager.rootStack, defaultFieldParams, defaultSettingsParams);
...
const createSourceMappings = (searchableObjectTypeDefinitions, context, lambda, parameterMap, lambdaDataSource) => {
